...
export async function renderUpcomingMovieCard(res) {
  try {
    ...
    const createUpcomingCard = results.map(result => {
      ...
      refs.galleryOfNewMovies.innerHTML = `
    ...
    <div class="upcoming__info">
      ...
      const remindBtn = document.querySelector('.upcoming__button');
      remindBtn.addEventListener('click', addLocalStorage);
